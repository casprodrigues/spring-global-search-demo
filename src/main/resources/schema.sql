/**
 Model: Northwind Sample Database
 From H2 port available at https://github.com/mrin9/northwind_spring
**/
...
select   oi.order_id    , oi.product_id  , oi.quantity     , oi.unit_price , oi.discount   , oi.date_allocated, oi.order_item_status
       , o.order_date   , o.order_status , o.paid_date     , o.payment_type, o.shipped_date, o.shipping_fee
       , o.ship_name    , o.ship_address1, o.ship_address2 , o.ship_city   , o.ship_state  , o.ship_postal_code, o.ship_country
       , p.product_code , p.product_name , p.category      , p.description , p.list_price
       , o.customer_id  , c.first_name customer_first_name , c.last_name  customer_last_name , c.phone customer_phone , c.email customer_email , c.company
       , o.employee_id  , e.first_name employee_first_name , e.last_name  employee_last_name , e.department, e.job_title employee_job_title
  From   orders o
       , products p
       , order_items oi
       , employees e
